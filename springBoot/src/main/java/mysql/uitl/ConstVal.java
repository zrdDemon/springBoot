...
public class ConstVal {
    ...
    public static final String RS_ENTITY_PATH = "com.eneity";
    public static final String RS_SERIVCE_PATH = "com.business.service";
    public static final String RS_SERVICEIMPL_PATH = "com.business.service.impl";
    public static final String RS_MAPPER_PATH = "com.ibatis.mapper";
    public static final String RS_XML_PATH = "com.ibatis.mapper";
    public static final String RS_CONTROLLER_PATH = "com.mvc.controller";
