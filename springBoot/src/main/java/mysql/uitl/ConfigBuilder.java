...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.ENTITY, ConstVal.RS_ENTITY_PATH);
        packageInfo.put(ConstVal.MAPPER, ConstVal.RS_MAPPER_PATH);
        packageInfo.put(ConstVal.XML, ConstVal.RS_XML_PATH);
        packageInfo.put(ConstVal.SERIVCE, ConstVal.RS_SERIVCE_PATH);
        packageInfo.put(ConstVal.SERVICEIMPL, ConstVal.RS_SERVICEIMPL_PATH);
        packageInfo.put(ConstVal.CONTROLLER,ConstVal.RS_CONTROLLER_PATH );
